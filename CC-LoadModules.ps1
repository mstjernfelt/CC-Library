...
Import-module CC.Powershell.NAV.Utilities -Force -WarningAction SilentlyContinue -ErrorAction SilentlyContinue
...
Import-module CC.Powershell.Azure.Utilities -Force -WarningAction SilentlyContinue -ErrorAction SilentlyContinue
